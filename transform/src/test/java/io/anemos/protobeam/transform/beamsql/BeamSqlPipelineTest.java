...
public class BeamSqlPipelineTest {
    ...
    public void initPipeline() {
        ProtoBeamSqlSchema.registerIn(pipeline)
                .message(ProtoBeamBasicPrimitive.class);
    }
    ...
    public void protoSum() {
        PCollection<Row> result =
                PBegin.in(pipeline)
                        ...
                        SqlTransform.query("select SUM(primitive_int32) from PCOLLECTION"));
