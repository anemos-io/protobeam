  ...
  private void toBqrimitive(Pipeline pipeline) {
    ...
    ProtoBeamBasicPrimitive m3 =
        ProtoBeamBasicPrimitive.newBuilder()
            ...
            .build();
    pipeline
        .apply(Create.of(m1, m2, m3))
        .apply(
            BigQueryWrite(
                ProtoBeamBasicPrimitive.class,
                ProtoBeamBasicPrimitive.getDescriptor(),
                "protobeam_primitive"));
  }

  private void toBqepeat(Pipeline pipeline) {
    ProtoBeamBasicRepeatPrimitive m1 =
        ProtoBeamBasicRepeatPrimitive.newBuilder()
            ...
            .build();
    ProtoBeamBasicRepeatPrimitive m2 =
        ProtoBeamBasicRepeatPrimitive.newBuilder()
            .setTestIndex(2)
            .setTestName("io.anemos.protobuf.examples.ProtoToBigQueryPipeline.toBqepeat")
            .addRepeatedInt32(12)
            .addRepeatedInt32(34)
            .build();
    ProtoBeamBasicRepeatPrimitive m3 =
        ProtoBeamBasicRepeatPrimitive.newBuilder()
            .setTestIndex(3)
            .setTestName("io.anemos.protobuf.examples.ProtoToBigQueryPipeline.toBqepeat")
    ...
    pipeline
        ...
        .apply(
            BigQueryWrite(
                ProtoBeamBasicRepeatPrimitive.class,
                ProtoBeamBasicRepeatPrimitive.getDescriptor(),
                "protobeam_repeat"));
  }

  private void toBqMessage(Pipeline pipeline) {
    ProtoBeamBasicMessage m1 =
        ProtoBeamBasicMessage.newBuilder()
            .setTestIndex(1)
            .setTestName("io.anemos.protobuf.examples.ProtoToBigQueryPipeline.toBqMessage")
            .setMessage(ProtoBeamBasicPrimitive.newBuilder().setPrimitiveString("abc").build())
            .build();
    ProtoBeamBasicMessage m2 =
        ProtoBeamBasicMessage.newBuilder()
            .setTestIndex(2)
            .setTestName("io.anemos.protobuf.examples.ProtoToBigQueryPipeline.toBqMessage")
            .setMessage(ProtoBeamBasicPrimitive.newBuilder().setPrimitiveDouble(42.13).build())
            .build();
    ProtoBeamBasicMessage m3 =
        ProtoBeamBasicMessage.newBuilder()
            .setTestIndex(3)
            .setTestName("io.anemos.protobuf.examples.ProtoToBigQueryPipeline.toBqMessage")
            .setMessage(ProtoBeamBasicPrimitive.newBuilder().setPrimitiveInt32(14).build())
            .addRepeatedMessage(
                ProtoBeamBasicPrimitive.newBuilder().setPrimitiveString("row 3.1").build())
            .addRepeatedMessage(
                ProtoBeamBasicPrimitive.newBuilder().setPrimitiveString("row 3.2").build())
            .build();
    pipeline
        .apply(Create.of(m1, m2, m3))
        .apply(
            BigQueryWrite(
                ProtoBeamBasicMessage.class,
                ProtoBeamBasicMessage.getDescriptor(),
                "protobeam_message"));
  }

  private void toBqOption(Pipeline pipeline) {
    int ix = 1;
    ProtoBeamOptionMessage m1 =
        ProtoBeamOptionMessage.newBuilder()
            .setTestIndex(ix++)
    ...
    pipeline
        ...
        .apply(
            BigQueryWrite(
                ProtoBeamOptionMessage.class,
                ProtoBeamOptionMessage.getDescriptor(),
                "protobeam_option"));
  }

  private void toBqWkt(Pipeline pipeline) {
    int ix = 1;
    ProtoBeamWktMessage m1 =
        ProtoBeamWktMessage.newBuilder()
            ...
            .build();
    ProtoBeamWktMessage m2 =
        ProtoBeamWktMessage.newBuilder()
            .setTestIndex(ix++)
            .setTestName("io.anemos.protobuf.examples.ProtoToBigQueryPipeline.toBqWkt")
            .setTimestamp(tsGenerator.nextTimestamp())
            .build();
    ProtoBeamWktMessage m3 =
        ProtoBeamWktMessage.newBuilder()
            .setTestIndex(ix++)
            .setTestName("io.anemos.protobuf.examples.ProtoToBigQueryPipeline.toBqWkt")
            .setTimestamp(tsGenerator.nextTimestamp())
            .build();
    ProtoBeamWktMessage m4 =
        ProtoBeamWktMessage.newBuilder()
            .setTestIndex(ix++)
            .setTestName("io.anemos.protobuf.examples.ProtoToBigQueryPipeline.toBqWkt")
            .setTimestamp(tsGenerator.nextTimestamp())
            .build();
    pipeline
        .apply(Create.of(m1, m2, m3, m4))
        .apply(
            BigQueryWrite(
                ProtoBeamWktMessage.class, ProtoBeamWktMessage.getDescriptor(), "protobeam_wkt"));
  }

  private void toBqSpecial(Pipeline pipeline) {
    int ix = 1;
    ProtoBeamBasicSpecial m1 =
