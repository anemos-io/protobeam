...
public class PartitionColumnConvert
    extends AbstractMessageConvert<Object, TableRow, Map<String, Object>> {
  ...
  public void fromProto(Message message, TableRow row) {
    ...
    Timestamp sourceTime =
        (Timestamp) message.getField(descriptor.findFieldByName(sourceFieldName));
    ...
    switch (context.getTimePartitioningTruncate(descriptor)) {
      ...
      default:
        throw new RuntimeException(
            "TimePartitioningTruncate value: "
                + context.getTimePartitioningTruncate(descriptor)
                + "not supported.");
    }
